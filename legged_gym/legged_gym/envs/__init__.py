...
from legged_gym.envs.k1.k1_config_ground import K1Cfg as K1CfgGround
from legged_gym.envs.k1.k1_config_ground import K1CfgPPO as K1CfgPPOGround
...
task_registry.register( "k1_ground", LeggedRobotGround, K1CfgGround(), K1CfgPPOGround())